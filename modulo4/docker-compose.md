...
* El escenario está formado por `services`. Cada uno ello va a crear un contenedor.
...
* `depends_on`: Indica la dependencia entre contenedores. No se va a iniciar un contenedor hasta que otro este funcionando. [Más información](https://docs.docker.com/compose/compose-file/compose-file-v3/#depends_on).
