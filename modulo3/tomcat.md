...
Tenemos un directorio donde tenemos el fichero war (puedes encontrar estos ficheros en el [repositorio github](https://github.com/victoria-nr/curso_docker_ies/tree/main/ejemplos/modulo3/ejemplo4)):
