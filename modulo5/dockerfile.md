...
* **ENV**: Para establecer variables de entorno dentro del contenedor. Puede ser usado posteriormente en las órdenes RUN añadiendo $ delante del nombre de la variable de entorno. Ejemplo: `ENV WEB_DOCUMENT_ROOT=/var/www/html`. No se puede usar con ENTRYPOINT Y CMD.
...
victorianr/myapache2       v2                  3bd28de7ae88        43 seconds ago      195MB
...
```
...
```bash
$ docker run -d -p 8080:80 --name servidor_web victorianr/myapache2:v2 
```            
